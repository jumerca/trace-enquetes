const CACHE='studio24-v6-living-1';
const ASSETS=['./','index.html','styles.css','mobile.css','v6.css','app-core.js','app-pages.js','app-engine.js','v6-enhance.js','manifest.json','icon.svg'];
